          ...
          >
            <div
              className={`relative bg-gradient-to-br ${
                ...
                clickedItem === index ? 'ring-2 ring-blue-400 ring-opacity-50' : ''
              }`}
            >
              {/* Header */}
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <h3
                    ...
                    } ${clickedItem === index ? 'text-blue-700' : ''}`}
                  >
                    {experience.title}
                  </h3>
                  <p className={`font-semibold ${
                    clickedItem === index ? 'text-blue-700' : 'text-blue-600'
                  }`}>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {isMobile && (
                  ...
                  >
                    <svg
                      className={`w-5 h-5 ${
                        clickedItem === index ? 'text-blue-700' : 'text-blue-500'
                      }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      ...
                      {experience.points.map((point, pointIndex) => (
                        ...
                        >
                          <div className={`w-2 h-2 rounded-full mt-2 mr-3 flex-shrink-0 ${
                            clickedItem === index ? 'bg-blue-600' : 'bg-blue-500'
                          }`}></div>
